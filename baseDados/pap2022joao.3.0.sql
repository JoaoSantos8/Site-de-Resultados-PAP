...
CREATE TABLE `galeria` (
  ...
  `galeriaFotoURL` varchar(255) NOT NULL,
  `galeriaData` date NOT NULL,
...
-- Records of galeria
-- ----------------------------
INSERT INTO galeria VALUES ('3', 'images/galeria/andre.jpg', '2022-07-14');
...
INSERT INTO noticias VALUES ('6', 'O onze dos le̵es para o jogo com o Villarreal', '2022-07-17', 'images/noticias/noticia3.jpg', '<p style=\"text-align: justify;\">O Sporting divulgou o onze que vai iniciar o jogo amig&aacute;vel frente ao Villarreal, no Est&aacute;dio Algarve, em Faro. Destaque para a presen&ccedil;a de Francisco Trinc&atilde;o no banco de suplentes, pelo que o refor&ccedil;o contratado ao Barcelona poder&aacute; ter os primeiros minutos de jogo pelos le&otilde;es.</p>\r\n<p style=\"text-align: justify;\">&nbsp;</p>\r\n<p style=\"text-align: justify;\"><strong>Onze titular:</strong></p>\r\n<div id=\"inread-videoad\" style=\"text-align: justify;\"></div>\r\n<p style=\"text-align: justify;\">Ad&aacute;n, Mars&agrave;, Gon&ccedil;alo In&aacute;cio e Matheus Reis; Ricardo Esgaio, Ugarte, Matheus Nunes e Nuno Santos;&nbsp;Pedro Gon&ccedil;alves, Bruno Tabata e Paulinho</p>\r\n<p style=\"text-align: justify;\">&nbsp;</p>\r\n<p style=\"text-align: justify;\"><strong>Suplentes:</strong></p>\r\n<p style=\"text-align: justify;\">Franco Israel, Andr&eacute; Paulo, Hevertton Santos, Diogo Travassos, D&aacute;rio Essugo, Renato Veiga, Francisco Trinc&atilde;o e Rodrigo Ribeiro.</p>\r\n<p>&nbsp;</p>\r\n<section id=\"abola-sondagem\"></section>');
